...
ALTER TABLE member
        ADD CONSTRAINT MEMB_AVT_FK FOREIGN KEY(mno) REFERENCES AVATAR(ano)
 ;
...
CREATE TABLE avatar(
    ...
    aname VARCHAR2(20 CHAR)
        CONSTRAINT AVAT_NAME_UK UNIQUE
        CONSTRAINT AVAT_NAME_NN NOT NULL,
    asave VARCHAR2(20 CHAR)
        CONSTRAINT AVAT_SAVE_UK UNIQUE
        CONSTRAINT AVAT_SAVE_NN NOT NULL,
        CONSTRAINT AVAT_SAVE_CK CHECK(ASAVE LIKE '%.jpg'),
    aloc VARCHAR2(200 BYTE) 
        CONSTRAINT AVAT_LOC_NN NOT NULL,
    asize NUMBER(10)
        CONSTRAINT AVAT_SIZE_NN NOT NULL,
    adate DATE DEFAULT SYSDATE
        CONSTRAINT AVAT_DATE_NN NOT NULL,
    awrit NUMBER(4) 
        CONSTRAINT AVAT_WRIT_FK REFERENCES member(mno)
        CONSTRAINT AVAT_WRIT_NN NOT NULL,
    isshow CHAR(1) DEFAULT 'Y'
        CONSTRAINT AVAT_SHOW_NN NOT NULL
        CONSTRAINT AVAT_SHOW_CK CHECK(ISSHOW IN('Y', 'N'))
);


ALTER TABLE member
    MODIFY avatar NUMBER(4) 
...
CREATE TABLE BOOK(
    ...
    bname NUMBER(4)
        CONSTRAINT BK_NAME_FK REFERENCES member(mno)
        CONSTRAINT BK_NAME_NN NOT NULL,
    bbody VARCHAR2(1000)
        CONSTRAINT BK_BODY_NN NOT NULL,
    bdate DATE DEFAULT SYSDATE
        CONSTRAINT BK_DATE_NN NOT NULL,
    isshow CHAR(1) DEFAULT 'Y'
        CONSTRAINT BK_SHOW_NN NOT NULL
        CONSTRAINT BK_SHOW_CK CHECK(ISSHOW IN ('Y','N'))
);
